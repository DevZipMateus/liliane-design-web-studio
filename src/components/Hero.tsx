...
const Hero = () => {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center pt-20 sm:pt-24">
      <div
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="max-w-2xl bg-background/20 backdrop-blur-sm p-6 sm:p-8 md:p-10 rounded-2xl">
          ...
          <h2 className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground mb-6 sm:mb-8 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            <Button
              ...
              size="lg"
              className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-elegant text-base sm:text-lg px-6 sm:px-8 w-full sm:w-auto"
            >
              Ver projetos
            </Button>
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground text-base sm:text-lg px-6 sm:px-8 w-full sm:w-auto"
            >
              Fale conosco
            </Button>
          </div>
