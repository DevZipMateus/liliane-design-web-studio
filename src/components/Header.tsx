      ...
      >
        <div className="container mx-auto px-4 py-3 sm:py-4">
          <nav className="flex items-center justify-between">
            ...
            >
              <img src={logo} alt="Lilian Design de Interiores" className="h-10 sm:h-12 w-auto" />
            </button>
        ...
        <div className="fixed inset-0 z-40 md:hidden">
          ...
          <nav className="relative mt-[72px] bg-background/98 backdrop-blur-md border-b border-border shadow-elegant">
            <div className="container mx-auto px-4 py-6 flex flex-col gap-4">
              <button
                onClick={() => scrollToSection("sobre")}
                className="text-left py-3 px-4 text-foreground/80 hover:text-primary hover:bg-muted/50 rounded-lg transition-smooth font-medium"
              >
                Sobre
              </button>
              <button
