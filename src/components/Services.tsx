...
const Services = () => {
  return (
    <section id="servicos" className="py-12 sm:py-16 md:py-20 lg:py-24 bg-background">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center mb-12 sm:mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6">Serviços</h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 max-w-6xl mx-auto">
          {services.map((service, index) => {
            ...
            return (
              <div
                key={index}
                className="group p-6 sm:p-8 rounded-lg bg-card border border-border hover:shadow-elegant transition-smooth hover:-translate-y-1"
              >
